...
## Loading the data
df_train_dev_split = pd.read_csv('../data/train_dev.csv')
df_test_dev_split = pd.read_csv('../data/test_dev.csv')
######
P_list = [0.485, 0.441, 0.342, 0.327, 0.324, 0.27]
P_pr_sess = 0.2
#### Data Preprocessing
## add nans to df_test_dev_split
...
df_to_submit.to_csv('../data/Rule_based_Test_Dev.csv')